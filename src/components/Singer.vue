<template lang="html">
  ...
  <el-form :model="addForm" class="addForm" :rules="rules" status-icon ref="addForm">
    ...
    <el-form-item label="性别:" :label-width="formLabelWidth" prop="singerSex">
     ...
     <el-form-item label="专辑:" :label-width="formLabelWidth" prop="album">
      <el-input v-model="addForm.album" auto-complete="off" placeholder="请输入歌手专辑"></el-input>
    </el-form-item>
...
<!-- 修改数据 -->
  ...
  <el-form :model="modifyForm" class="addForm" :rules="rules" status-icon ref="modifyForm">
    ...
    <el-form-item label="性别:" :label-width="formLabelWidth" prop="singerSex">
     ...
     <el-form-item label="专辑:" :label-width="formLabelWidth" prop="album">
      <el-input v-model="modifyForm.album" auto-complete="off" placeholder="请输入歌手专辑"></el-input>
    </el-form-item>
  ...
  data: function() {
    return {
      ...
      rules: {
        ...
        age: [
          { required: true, message: "请输入歌手年龄", trigger: "blur" },
        ...
        album: [
          { required: true, message: "请输入歌手专辑", trigger: "blur" }
        ],
        singerPosition: [
          {
            required: true,
